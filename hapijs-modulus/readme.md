This is a record of following along with the modulus tutorial for [creating a rest API using hapi](http://blog.modulus.io/nodejs-and-hapi-create-rest-api) as part of my efforts to learn hapi.js.
